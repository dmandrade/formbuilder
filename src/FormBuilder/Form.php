...
class Form
{
    ...
    public function rebuildForm()
    {
        ...
        if (get_class($this) === 'Dmandrade\FormBuilder\Form') {
     ...
     * @return $this
     */
    public function add($name, $type = 'text', array $options = [], $modify = false, $includeToForm = true)
    {
        ...
        /*if(isset($options['locales']) and is_array($options['locales'])) {
            foreach($options['locales'] as $locale) {
                $localeOptions = $options;
                $localeName = $locale.'['.$name.']';
                $localeOptions['attr']['data-language'] = $locale;
                if(!isset($localeOptions['label']))
                    $localeOptions['label'] = ucfirst($name).' ('.$locale.')';
                $this->addField($this->makeField($localeName, $type, $localeOptions), $modify);
            }
        }else{*/

        return $this->addField($this->makeField($name, $type, $options), $modify, $includeToForm);
    }
    ...
    protected function addField(FormField $field, $modify = false, $includeToForm=true)
    {
        ...
        if ($field->getType() == 'file' && $field->getType() == 'upload') {
    ...
    protected function render($options, $fields, $showStart, $showFields, $showEnd)
    {
        ...
        //$tabs = $this->getFieldsByOption('tab', 'default');
